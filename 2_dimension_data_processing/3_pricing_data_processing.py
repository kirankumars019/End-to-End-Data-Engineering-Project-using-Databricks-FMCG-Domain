...
# making standard date formant yyyy-MM-dd 2025-07-01
...
#validating the gross_price column, converting only valid numeric values to double, fixing negative prices by making them positive, and replacing all non-numeric values with 0
...
# MAGIC %md
# MAGIC - Get the price for each product_code (aggregated by year) -Getting Latest Maximum price of Prodcut 
...
# using window function by poduct code & year
w = (
    Window
...
# merging data from source to target table
