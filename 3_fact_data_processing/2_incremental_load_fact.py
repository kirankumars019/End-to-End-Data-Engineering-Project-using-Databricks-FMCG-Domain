...
# MAGIC %md
# MAGIC ### Moving files from source(Landing Path) to processed Path directory - S3
...
# monthy table will contain all the records from historical data 
